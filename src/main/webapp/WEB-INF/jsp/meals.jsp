    ...
    <div class="jumbotron pt-4">
        <div class="container">
            ...
            <form id="filterForm">
                ...
                <button onclick="filterMeal()"><spring:message code="meal.filter"/></button>
            </form>
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        <label class="col-form-label"><spring:message code="meal.dateTime"/></label>
                        <input type="datetime-local" class="form-control" id="dateTime" name="dateTime"
                               placeholder="<spring:message code="meal.dateTime"/>">
                    </div>

                    <div class="form-group">
                        <label class="col-form-label"><spring:message code="meal.description"/></label>
                        <input type="text" class="form-control" id="description" name="description"
                               placeholder="<spring:message code="meal.description"/>">
                    </div>

                    <div class="form-group">
                        <label class="col-form-label"><spring:message code="meal.calories"/></label>
